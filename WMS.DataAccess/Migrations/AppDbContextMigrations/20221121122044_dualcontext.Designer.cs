...
namespace WMS.DataAccess.Migrations
{
    ...
    [Migration("20221121122044_dualcontext")]
    partial class dualcontext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Models.IncDeliveryOrderArrival", b =>
                {
                    ...
                    b.Property<string>("NoteNotArrived")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WMS.Models.IncDeliveryOrderArrivalProduct", b =>
                {
                    ...
                    b.ToTable("IncDeliveryOrderArrivalProduct", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.IncDeliveryOrderProduct", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DOProductId"));
            ...
            modelBuilder.Entity("WMS.Models.IncPurchaseOrderProduct", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("POProductId"));
            ...
            modelBuilder.Entity("WMS.Models.IncRequestPurchaseProduct", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RequestProductId"));
            ...
            modelBuilder.Entity("WMS.Models.IncSerialNumber", b =>
                {
                    ...
                    b.ToTable("IncSerialNumber", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.InvPickingRouteColumn", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RouteColumn"));
            ...
            modelBuilder.Entity("WMS.Models.InvReturn", b =>
                {
                    ...
                    b.HasKey("ReturnNumber");

                    b.HasIndex("HouseCode");

                    b.HasIndex("TenantId");

                    b.ToTable("InvReturn", (string)null);
                });

            modelBuilder.Entity("WMS.Models.InvReturnProduct", b =>
                {
                    b.Property<int>("ReturnProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReturnProductId"));
                    ...
                    b.ToTable("InvReturnProduct", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.InvStockOpname", b =>
                {
                    b.Property<string>("OpnameId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateTime>("DateOpname")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("InvStockOpname", (string)null);
                });

            modelBuilder.Entity("WMS.Models.InvStockOpnameProduct", b =>
                {
                    b.Property<string>("OpnameProductId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("OpnameProductId");

                    b.HasIndex("OpnameId");

                    b.HasIndex("ProductId");

                    b.ToTable("InvStockOpnameProduct", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.InvStorageCategory", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StorageCategoryId"));
            ...
            modelBuilder.Entity("WMS.Models.MasCustomerType", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CustTypeId"));
            ...
            modelBuilder.Entity("WMS.Models.MasPricing", b =>
                {
                    ...
                    b.Property<float>("PPh")
                        .HasColumnType("real");

                    b.Property<float>("ReceivingFeeMin")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("WMS.Models.MasProductBundling", b =>
                {
                    b.Property<string>("BundlingId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("MasProductBundling", (string)null);
                });

            modelBuilder.Entity("WMS.Models.MasProductBundlingData", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("MasProductBundlingData", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.MasSalesType", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StyId"));
            ...
            modelBuilder.Entity("WMS.Models.OutSalesOrderProduct", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrdProductId"));
            ...
            modelBuilder.Entity("WMS.Models.SecUserTenant", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("SecUserTenant", (string)null);
                });

            modelBuilder.Entity("WMS.Models.SecUserWarehouse", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("SecUserWarehouse", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Models.IncDeliveryOrderArrivalProduct", b =>
                {
                    b.HasOne("WMS.Models.IncDeliveryOrderArrival", "IncDeliveryOrderArrival")
                        .WithMany("IncDeliveryOrderArrivalProducts")
            ...
            modelBuilder.Entity("WMS.Models.InvReturnProduct", b =>
                {
                    ...
                    b.HasOne("WMS.Models.InvReturn", "InvReturn")
                        .WithMany("InvReturnProducts")
                        .HasForeignKey("ReturnNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Models.InvStockOpnameProduct", b =>
                {
                    b.HasOne("WMS.Models.InvStockOpname", "InvStockOpname")
                        .WithMany("InvStockOpnameProducts")
                        .HasForeignKey("OpnameId");
            ...
            modelBuilder.Entity("WMS.Models.InvStorageCode", b =>
                {
                    b.HasOne("WMS.Models.InvStorageBin", "InvStorageBin")
                        .WithOne("InvStorageCode")
                        .HasForeignKey("WMS.Models.InvStorageCode", "BinCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Models.MasInvoicingDetail", b =>
                {
                    b.HasOne("WMS.Models.MasInvoicing", "MasInvoicing")
                        .WithMany("MasInvoicingDetails")
                        .HasForeignKey("InvoiceNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MasInvoicing");
                });
            ...
            modelBuilder.Entity("WMS.Models.MasPricingAdditional", b =>
                {
                    b.HasOne("WMS.Models.MasPricing", "MasPricing")
                        .WithMany("MasPricingAdditionals")
            ...
            modelBuilder.Entity("WMS.Models.MasProductBundlingData", b =>
                {
                    b.HasOne("WMS.Models.MasProductBundling", "MasProductBundling")
                        .WithMany("MasProductBundlingDatas")
                    ...
                    b.Navigation("MasProductBundling");
            ...
            modelBuilder.Entity("WMS.Models.OutSalesOrderAssign", b =>
                {
                    b.HasOne("WMS.Models.OutSalesOrder", "OutSalesOrder")
                        .WithOne("OutSalesOrderAssign")
                        .HasForeignKey("WMS.Models.OutSalesOrderAssign", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Models.OutSalesOrderPack", b =>
                {
                    b.HasOne("WMS.Models.OutSalesOrderProduct", "OutSalesOrderProduct")
                        .WithOne("OutSalesOrderPack")
                        .HasForeignKey("WMS.Models.OutSalesOrderPack", "OrdProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Models.SecUserTenant", b =>
                {
                    b.HasOne("WMS.Models.MasDataTenant", "MasDataTenant")
                        .WithMany("SecUserTenants")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WMS.Models.SecUser", "SecUser")
                        .WithOne("SecUserTenant")
                        .HasForeignKey("WMS.Models.SecUserTenant", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Models.IncDeliveryOrderArrival", b =>
                {
                    b.Navigation("IncDeliveryOrderArrivalProducts");
            ...
            modelBuilder.Entity("WMS.Models.InvReturn", b =>
                {
                    b.Navigation("InvReturnProducts");
                });

            modelBuilder.Entity("WMS.Models.InvStockOpname", b =>
                {
                    b.Navigation("InvStockOpnameProducts");
                });
            ...
            modelBuilder.Entity("WMS.Models.InvStorageRow", b =>
                {
                    ...
                    b.Navigation("InvStorageSections");
                });
            ...
            modelBuilder.Entity("WMS.Models.MasDataTenant", b =>
                {
                    ...
                    b.Navigation("MasInvoicings");

                    b.Navigation("MasProductDatas");

                    b.Navigation("MasStores");

                    b.Navigation("MasSupplierDatas");

                    b.Navigation("OutSalesOrders");

                    b.Navigation("SecUserTenants");
                });
            ...
            modelBuilder.Entity("WMS.Models.MasHouseCode", b =>
                {
                    ...
                    b.Navigation("SecUserWarehouses");
                });
            ...
            modelBuilder.Entity("WMS.Models.MasInvoicing", b =>
                {
                    b.Navigation("MasInvoicingDetails");
                });
            ...
            modelBuilder.Entity("WMS.Models.MasPricing", b =>
                {
                    b.Navigation("MasPricingAdditionals");
                });

            modelBuilder.Entity("WMS.Models.MasProductBundling", b =>
                {
                    b.Navigation("MasProductBundlingDatas");
                });
            ...
            modelBuilder.Entity("WMS.Models.OutSalesOrder", b =>
                {
                    ...
                    b.Navigation("OutSalesOrderAssign");
            ...
            modelBuilder.Entity("WMS.Models.OutSalesOrderProduct", b =>
                {
                    ...
                    b.Navigation("OutSalesOrderPack");
