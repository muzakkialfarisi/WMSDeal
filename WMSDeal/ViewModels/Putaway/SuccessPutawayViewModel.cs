...
{
    public class SuccessPutawayViewModel : BaseViewModel
    {
        private int _total;
        ...
        public SuccessPutawayViewModel()
        {
            GetPeriode();
        }
                ...
                if (Connectivity.Current.NetworkAccess == NetworkAccess.Internet)
                {
                    Application.Current.Dispatcher.Dispatch(async () =>
                    {
                        try
                        {
                            ...
                            {
                                var response = await deliveryOrderService.GetDeliveryOrders("PUT", Periode);
        ...
        public ICommand SelectItemCommand => new Command<DeliveryOrder>(async (pwDetail) =>
        {
            if (Connectivity.Current.NetworkAccess == NetworkAccess.Internet)
            {
                try
                {
                    ...
                    {
                        //await Shell.Current.GoToAsync(nameof(PutawayDetailPage), DeliveryOrder);
                    }
