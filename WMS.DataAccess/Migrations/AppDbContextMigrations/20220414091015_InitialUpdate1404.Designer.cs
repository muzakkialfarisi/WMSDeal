...
namespace WMS.DataAccess.Migrations
{
    ...
    [Migration("20220414091015_InitialUpdate1404")]
    partial class InitialUpdate1404
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.WMSDeal.Models.MasProductData", b =>
                {
                    ...
                    b.Property<decimal?>("ResellablePrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("App.WMSDeal.Models.MasSalesPlatform", b =>
                {
                    b.Property<int>("SplId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SplId"), 1L, 1);

                    b.Property<string>("SplCode")
                        .IsRequired()
                        .HasMaxLength(25)
                        .HasColumnType("nvarchar(25)");

                    b.Property<string>("SplName")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.ToTable("MasSalesPlatform", (string)null);
                });
            ...
            modelBuilder.Entity("App.WMSDeal.Models.OutSalesOrderPick", b =>
                {
                    b.Property<int>("PickId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PickId"), 1L, 1);
                    ...
                    b.ToTable("OutSalesOrderPick", (string)null);
                });
            ...
            modelBuilder.Entity("App.WMSDeal.Models.InvPickingRouteColumn", b =>
                {
                    ...
                    b.HasOne("App.WMSDeal.Models.InvPickingRoute", "InvStorageRoute")
            ...
            modelBuilder.Entity("App.WMSDeal.Models.OutSalesOrder", b =>
                {
                    ...
                    b.HasOne("App.WMSDeal.Models.MasSalesPlatform", "MasSalesPlatform")
                        .WithMany()
                        .HasForeignKey("OrdPlatform")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.WMSDeal.Models.OutSalesOrderPack", b =>
                {
                    ...
                    b.HasOne("App.WMSDeal.Models.OutSalesOrderPick", "OutSalesOrderPick")
                        .WithMany()
                    ...
                    b.Navigation("OutSalesOrderPick");
                });
            ...
            modelBuilder.Entity("App.WMSDeal.Models.OutSalesOrderProduct", b =>
                {
                    b.Navigation("OutSalesOrderPicks");
                });
